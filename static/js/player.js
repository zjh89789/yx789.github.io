$("#music").append('<div id="xplayer" style="background: rgba(53, 54, 64, 0.8);"><div class="player"><div class="cover"></div><div class="edge"></div><div class="status"><i class="play fa fa-play" title="播放"></i><i class="pause fa fa-pause" title="暂停"></i></div><div class="info"><div class="songstyle"><i class="fa fa-music"></i> 正在播放:<span class="song"><span title=""></span><span></div><div class="artiststyle"><i class="fa fa-user"></i> <span class="artist"><span title=""></span></span></div><div class="albumstyle"><i class="fa fa-folder"></i> <span class="album"><span title=""></span></span></div></div><div class="control"><i class="aprev fa fa-fast-backward" title="上一专辑"></i><i class="prev fa fa-backward" title="上一首"></i><i class="next fa fa-forward" title="下一首"></i><i class="anext fa fa-fast-forward" title="下一专辑"></i></div><div class="foot"><div class="volumecontrol"><div class="volume fa fa-volume-up"></div><div class="volumeprogress"><div class="progressbg"><div class="progressbg1"></div><div class="ts"></div></div></div></div><div class="playprogress" title="00:00 / 00:00"><div class="progressbg"><div class="progressbg1"></div><div class="progressbg2"></div><div class="ts"></div></div></div><div class="switch-ksclrc"><i class=\"random fa fa-toggle-on\" title="关闭歌词"></i></div><div class="qhms"><i class="random fa fa-retweet" title="专辑循环"></i></div><div class="switch-playlist"><i class="fa fa-bars" title="播放列表"></i></div></div></div><div class="playlist"><div class="playlist-bd"><div class="album-list"><div class="musicheader"></div><div class="list"></div></div><div class="song-list"><div class="musicheader"><i class="fa fa-angle-right"></i><span></span></div><div class="list">				<span></span></div></div></div></div><div class="switch-player" style="background: rgba(0, 0, 0, 0.50);"><i class="fa fa-angle-right" style="margin-top: 200%;"></i></div></div><div id="Tips" class=""></div><div id="Ksc" class=""></div><div id="Lrc" class=""></div>');
...
var span = document.createElement("span");
		...
		if (css(span, "font-family") === "FontAwesome") {
			...
			$("head").append("<link rel='stylesheet' id='font-awesome-css'  href='https://lib.baomitu.com/font-awesome/4.7.0/css/font-awesome.min.css' type='text/css' media='all' />")
		};
...
var audio = new Audio(),
		...
		var $Volumeprogress = $(".volumeprogress .progressbg .ts", $player);
			$Volumeprogress.Drag({
				...
				callback: function(a, b, c, e, g) {
					if (5 == arguments.length) {
						...
						var d;
						d = ((84 - c) / 84).toFixed(2);
						1 < Number(d) ? d = 1 : 0 > Number(d) && (d = 0, $(a).css("top", "84%"));
			...
			$(".volumeprogress .progressbg", $player).click(function(a) {
				...
				$(".volumeprogress .progressbg .ts", $player).css("top", 100 * (1 - a) + "%");
		...
		$(".switch-ksclrc").click(function() {
				...
				if (!$("#Lrc").hasClass("hide") || !$("#Ksc").hasClass("hidePlayer")) {
					ycgeci = true;
					Tips.show("开启歌词显示");
		...
		$(".qhms", $player).click(function() {
				random ? (random = false, Tips.show("专辑循环"), $(this).html("<i class = \"random fa fa-retweet\" title=\"专辑循环\"></i>")) : (loop ? (random = true, loop = false, Tips.show("随机播放"), $(this).html("<i class = \"random fa fa-random\" title=\"随机播放\"></i>")) : (random = false, loop = true, Tips.show("单曲循环"), $(this).html("<i class = \"random fa fa-refresh\" title=\"单曲循环\"></i>")));
			});
		...
		playList = {
				creat: {
					album: function() {
						$(".musicheader", $albumList).html(playerinfo.playerName +" - 歌单列表")
						...
						$(".current", $albumList).click(function() {
							$player.addClass("showSongList");
							$albumList.hide(500);
							$(".musicheader", $albumList).hide();
						});
						$("li", $albumList).click(function() {
							var a = $(this).index();
							$(this).hasClass(cur) ? playList.creat.song(a, true) : playList.creat.song(a, false);
							$player.addClass("showSongList");
							$albumList.hide(500);
							$(".musicheader", $albumList).hide();
						});
					...
					song: function(a, b) {
						...
						$(".song-list .musicheader span", $player).text(playerinfo.Sheetlist[a].SheetName + "(" + songTotal + ")");
						var c = "";
						for (var i = 0; i < songTotal; i++) {
							...
							$("span", $songList).html("<ul>" + c + "</ul>").mCustomScrollbar();
						...
						$(".song-list .musicheader", $player).click(function() {
							$albumList.show(500);
							$(".musicheader", $albumList).show(200);
						})
...
$("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\""+api+"/Static/player2/css/player.css\">");
} else if (playerinfo.showColors == "1"){
$("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\""+api+"/Static/player2/css/player2.css\">");
}
				//默认音量
				...
				volume = $.cookie("player_volume") ? $.cookie("player_volume") : vol;
					if (100 * volume != "0") {
						...
						$(".volumeprogress .progressbg .ts", $player).css("top", "40px")
					};
...
function startPlay() {
	...
	if (a) {
		a.then(() => {
			...
			consolelog("当前播放",playerinfo.Sheetlist[albumId].songs[songId].name + " - " + playerinfo.Sheetlist[albumId].songs[songId].artist + " 时长：" + Math.floor(t / 60) + ":" + (t % 60 / 100).toFixed(2).slice(-2));
		}).catch((e) => {
